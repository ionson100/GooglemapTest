package com.example.ion.googlemap.yandex;
...
public class WifiAndCellCollector extends PhoneStateListener implements Runnable, LocationListener {
    ...
    public static final String API_KEY = "AIsrulkBAAAAw1AYAwIAkFkwnbp0A6_JuTgmre3cT6Pr33EAAAAAAAAAAADBi-cptrJzr9Y3rLHZBStjHsLKMA==";
    ...
    public static String getDeviceManufacturer() {
        String manufact;
        try {
            Class<Build> buildClass = android.os.Build.class;
